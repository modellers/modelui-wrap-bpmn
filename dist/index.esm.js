...
import BpmnJS$1 from 'bpmn-js/dist/bpmn-modeler.production.min.js';
import 'bpmn-js/dist/assets/diagram-js.css';
import 'bpmn-js/dist/assets/bpmn-font/css/bpmn.css';
import CmmnJS from 'cmmn-js/dist/cmmn-navigated-viewer.production.min.js';
import CmmnJS$1 from 'cmmn-js/dist/cmmn-modeler.production.min.js';
...
}(structs.StateBase.StateInstance);
var OMGBase = /*#__PURE__*/function (_structs$StateBaseCom) {
  ...
  return OMGBase;
}(structs.StateBaseComponent.StateBaseComponent);
  ...
  function BPMNEditorComponent() {
    ...
    return _possibleConstructorReturn(_this, (_this = _super.call.apply(_super, [this].concat(args)), _this.getInstance = function (container) {
      if (!_this.omgInstance) {
        ...
        _this.omgInstance = new BpmnJS$1({
          container: container
        });
      }
...
function BPMNViewer(props) {
  ...
  return /*#__PURE__*/React.createElement(BPMNViewerComponent, props);
}
function BPMNEditor(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(BPMNEditorComponent, props);
}
  ...
  function CMMNEditorComponent() {
    ...
    return _possibleConstructorReturn(_this, (_this = _super.call.apply(_super, [this].concat(args)), _this.getInstance = function (container) {
      if (!_this.omgInstance) {
        ...
        _this.omgInstance = new CmmnJS$1({
          container: container
        });
      }
...
function CMMNViewer(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(CMMNViewerComponent, props);
}
function CMMNEditor(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React.createElement(CMMNEditorComponent, props);
}
