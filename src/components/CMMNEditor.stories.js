...
import { CMMNEditorComponent } from './CMMNEditor';
import { triggers, events, config } from './CMMNEditor'

import { layout } from '../modelui-core-runtime';

export default {
  title: 'Extras/OMG CMMN',
  component: CMMNEditorComponent,
...
export const CMMNBasicEditor = (args) => {
  const props = {
    id: 'CMMNBasicEditor_id',
    type: 'cmmn-editor',
    data: [{
  ...
  return (
    <div>
      ...
      <CMMNEditorComponent {...props} />
    </div>
  );
};
CMMNBasicEditor.args = {
