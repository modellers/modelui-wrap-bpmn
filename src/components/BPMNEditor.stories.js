...
import { BPMNEditorComponent } from './BPMNEditor';
import { triggers, events, config } from './BPMNEditor'
...
export const BPMNBasicEditor = (args) => {

  const props = {
    id: 'BPMNBasicEditor_id',
    type: 'bpmn-editor',
    data: [{
  ...
  return (
    <div>
      ...
      <BPMNEditorComponent {...props} />
    </div>
  );
};
BPMNBasicEditor.args = {
  backgroundColor: 'white'
}
export const BPMNBasicEditor2 = (args) => {
  const props = {
    id: 'BPMNBasicEditor2_id',
    type: 'bpmn-editor',
    data: [{
      id: 'large-bpmn-example2',
      xml: bpmn_diagram_initial
    }],
    config: { options: args },
    schema: {}
